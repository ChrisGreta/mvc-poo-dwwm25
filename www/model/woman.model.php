...
class Woman {
    ...
    public $image;
    public $domaine;
    public $historical_facts = [];

    public function __construct($nom, $prenom, $date_naissance, $description, $image, $domaine, $date_deces = null) {
        $this->nom = $nom;
        $this->prenom = $prenom;
...
function getWomen(){
    $womenCelebs = [
        [
            ...
            "date_deces" => "1934-07-04", // Ajout de la date de décès
        ...
        [
            ...
            "date_deces" => "1992-01-01", // Ajout de la date de décès
        ...
        [
            ...
            "date_deces" => "2014-05-28", // Ajout de la date de décès
        ...
        [
            ...
            "date_deces" => null, // Serena Williams est encore en vie
